...
public class Constants {
    ...
    public final static String GETDATA_PROPERTIES_FILE = TEST_RESOURCES + File.separator + "Testdata" + File.separator + "GetSingleRepositoryData.properties";
    
    public final static String ADDDATA_PROPERTIES_FILE = TEST_RESOURCES + File.separator + "Testdata" + File.separator + "AddRepositoryData.properties";
    
    public final static String UPDATEDATA_PROPERTIES_FILE = TEST_RESOURCES + File.separator + "Testdata" + File.separator + "UpdateRepositoryData.properties";
