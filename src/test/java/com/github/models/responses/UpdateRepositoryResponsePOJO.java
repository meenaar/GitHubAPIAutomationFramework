...
public class UpdateRepositoryResponsePOJO<Permissions, Owner, SecurityAndAnalysis, SecretScanning, SecretScanningPushProtection, SecretScanningNonProviderPatterns, SecretScanningValidityChecks, DependabotSecurityUpdates> {
	...
	/*    @JsonProperty("events_url") 
	    ...
	    public SecurityAndAnalysis getSecurity_and_analysis() { 
			 return this.security_and_analysis; } 
	    public void setSecurity_and_analysis(SecurityAndAnalysis security_and_analysis) { 
	...
	*/
	    ...
	    public SecretScanningNonProviderPatterns getSecret_scanning_non_provider_patterns() { 
			 return this.secret_scanning_non_provider_patterns; } 
	    public void setSecret_scanning_non_provider_patterns(SecretScanningNonProviderPatterns secret_scanning_non_provider_patterns) { 
			 this.secret_scanning_non_provider_patterns = secret_scanning_non_provider_patterns; } 
